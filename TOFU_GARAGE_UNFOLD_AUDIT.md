...
| First Dream Build Investment | Wheels Fund purchase, Wheels work levels, Exhaust V1, Dream Build Progress, Showcase Prep V1, and Sponsor Inquiry V1 | Cash from Tofu Shop orders and shop automation | subtracts Cash, raises Project Car Value, can add one-time Cash and Brand Value through Sponsor Inquiry | decide whether to improve the project car or keep growing the shop | after covered-car teaser, stable shop state, Wheels level 3 for Exhaust, first `$1M Net Worth` for Showcase Interest, and Showcase Prep for Sponsor Inquiry | proves multi-part buy-once/work-level part model and first business-opportunity unlock | Tuned Note target preview, Wheels levels 4-5, recurring sponsor packages, future Dream Garage design | meaningful V1 purchase/work/progress |
| Net Worth Milestones | Long-term value ladder toward `$1T Net Worth` | Cash, Tofu Business Value, Project Car Value, Brand Value | milestone state is tracked; no separate spend | gives concrete stepping stones and unlocks Showcase Interest at first `$1M` | after Net Worth V1 is visible | vague `$1T` goal with no intermediate carrot | Showcase Prep, Sponsor Inquiry, later business opportunities | meaningful V1 guidance |
| Brand Value | Fictional value from project-car attention | one-time Sponsor Inquiry V1 | contributes to Net Worth V1 only | show car investment can create business value | after Showcase Prep and first `$1M Net Worth` | Net Worth path feels only like cash saving | recurring sponsor packages later | meaningful V1, no recurring income |
...
```text
Tuned Note target preview -> Wheels levels 4-5 or Exhaust levels 3-5 -> recurring sponsor package
