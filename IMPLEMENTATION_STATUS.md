...
| Progression | Station milestone boosts | Documented only | `EXTERNAL_REFERENCE_ANTIMATTER_DIMENSIONS_AUDIT.md`, `BALANCE_AND_PROGRESSION.md` | None | Design visibility and rewards after station costs/reveals are tuned | Future | Shop-only boosts; no Cup Test scoring or qualification effect |
