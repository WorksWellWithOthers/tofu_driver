...
| Automation | Counter Service automation | Documented only | `EXTERNAL_REFERENCE_ANTIMATTER_DIMENSIONS_AUDIT.md` | None | Implement only after manual order fulfillment clearly becomes a chore | Future | Parked-only automation; no active-drive actions |
