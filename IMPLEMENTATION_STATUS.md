...
| Progression | Next Milestone bar | Documented only | `EXTERNAL_REFERENCE_ANTIMATTER_DIMENSIONS_AUDIT.md`, `BALANCE_AND_PROGRESSION.md` | None | Consider as a small future Overview slice after first-loop playtesting | Future | One safe shop milestone at a time; no full roadmap or driving data |
