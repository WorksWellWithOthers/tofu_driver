...
- Exhaust Purchase + Work Level V1 implements level 1 Exhaust Fitted, level 2 Sealed Joints,
  level 3 Tuned Note, and level 4 Heat Wrapped. Combined Garage Build Value totals are `$275K`,
  `$475K`, `$825K`, and `$1.475M` respectively.
- Dream Build Progress V1 shows the project as `30` planned work stages. Current implemented stages
  are Wheels levels 1-3 and Exhaust levels 1-4.
...
- Treat Wheels and Exhaust levels 1-4 as the only current V1 Dream Build purchases. Do not add
  Showcase Finish purchase effects, full parts inventory, resale, depreciation, liabilities, or a separate
  project currency.
...
9. Keep Showcase Finish target-only until Exhaust level 4 proves the second part track.
