...
| Garage Expansion Board V1 | Implemented | Unlocks after the selected second-car assignment is collected; Third Bay Foundation, Event Office, and Fabrication Corner are one-time facility projects buildable in any order. They spend Cash plus Garage Reputation and add Garage Build Value or Brand Value through existing components; third-car acquisition, fleet management, assignment chains, backend/uploads, and network calls remain future. |
...
- Garage Event Board V1 makes the first `$100M` garage-era reward real once Tires & Rubber Level 5
  ...
  selected-direction proof assignment after the direction track reaches Level 5. Garage Expansion
  Board V1 adds three facility investments after that proof assignment is collected. Repeatable
  event boards, second-car assignment chains, third-car acquisition, full multi-car management,
  collector offers, and auctions remain future.
