...
- Tofu Garage Overview uses Glance Mode V1: Now, stable Pinned Goal, Era Goal, and compact Recent
  ...
  track is implemented through Showcase Stance; Tires & Rubber and Brakes & Control are
  implemented through their Level 5 completions; Garage Event Board V1 adds one-time parked
  fictional events after `$100M Net Worth` plus Tires Level 5; Induction & Cooling remains the next
  future build track.
