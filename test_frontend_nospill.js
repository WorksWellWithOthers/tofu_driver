...
`, context);
  ...
  assert.strictEqual(context.sealMilestone.id, 'dream_target_tuned_note');
  assert.strictEqual(context.sealAction.type, 'dream_investment_target');
  assert.strictEqual(context.sealAction.title, 'Next: Grow the shop for Tuned Note');
...
`, context);
  ...
  assert(html.includes('/static/nospill/app.js?v=20260617j'));
  assert(html.includes('/static/nospill/app.css?v=20260617j'));
}
