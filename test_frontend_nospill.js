...
`, context);
  ...
  assert(context.tunedProgressCardHtml.includes('Next Dream Step: Heat Wrapped · future'));
  assert(context.tunedProgressCardHtml.includes('Heat Wrapped comes in a future Dream Garage pass'));
  ...
  assert.strictEqual(context.tunedDreamNote, 'Next Dream Step: Heat Wrapped, future.');
  assert(context.tunedCardHtml.includes('Tuned Note'));
  assert(context.tunedCardHtml.includes('Exhaust Level 3 / 5'));
  assert(context.tunedCardHtml.includes('The exhaust has a clean, confident note.'));
  assert(context.tunedCardHtml.includes('Next Exhaust Work: Heat Wrapped'));
  assert(context.tunedCardHtml.includes('Full Dream Garage comes later'));
  assert(!context.tunedCardHtml.includes('Buy Heat Wrapped'));
  assert.strictEqual(context.tunedMilestone.id, 'prepare_showcase_display');
  assert.strictEqual(context.tunedAction.type, 'showcase_prep_target');
