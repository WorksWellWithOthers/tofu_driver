...
`, context);
  ...
  assert.strictEqual(context.suspensionFiveProgress.total, 30);
  assert(context.suspensionFiveCardHtml.includes('Suspension Complete'));
  assert(context.suspensionFiveCardHtml.includes('Level 5 / 5 · Showcase Stance'));
  assert(context.suspensionFiveCardHtml.includes('Next Build Track: Tires &amp; Rubber'));
  assert(context.suspensionFiveCardHtml.includes('Future garage pass.'));
  assert(!context.suspensionFiveCardHtml.includes('Buy Tires'));
  assert(!context.suspensionFiveCardHtml.includes('Install Tires'));
  assert.strictEqual(context.suspensionFivePinnedAfter.id, 'dream_build_suspension_complete');
  assert.strictEqual(context.suspensionFivePinnedAfter.title, 'Suspension complete');
  assert(context.suspensionFivePinnedAfter.body.includes('Tires & Rubber'));
  assert.strictEqual(context.suspensionFiveTickPinned.title, 'Suspension complete');
  assert.notStrictEqual(context.suspensionFiveActionAfter.type, 'buy_dream_suspension_work');
  ...
  assert(context.suspensionFivePanelHtml.includes('Current focus: Suspension &amp; Chassis Geometry.'));
  ...
  assert(!context.suspensionFivePanelHtml.includes('Buy Tires'));
  ...
  assert(context.dreamOverviewSummary.includes('13 / 30'));
  ...
  assert(context.dreamSummaryCard.includes('13 / 30 work stages'));
...
`, context);
  ...
  assert(html.includes('/static/nospill/app.js?v=20260619p'));
  assert(html.includes('/static/nospill/app.css?v=20260619p'));
}
