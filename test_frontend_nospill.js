...
`, context);
  ...
  assert(context.wheelsCardHtml.includes('Project Car Value started'));
  assert(context.wheelsCardHtml.includes('Next Dream Target: Exhaust'));
  assert(context.wheelsCardHtml.includes('Exhaust Fund'));
  ...
  assert.strictEqual(context.wheelsMilestone.id, 'dream_target_exhaust');
  assert.strictEqual(context.wheelsAction.type, 'dream_investment_target');
...
`, context);
  ...
  assert(html.includes('/static/nospill/app.js?v=20260617h'));
  assert(html.includes('/static/nospill/app.css?v=20260617h'));
}
