...
`, context);
  ...
  assert(context.fitmentCardHtml.includes('Wheels work is complete for now'));
  assert(context.fitmentCardHtml.includes('Future Wheels Work: Showpiece Fitment'));
  assert(context.fitmentCardHtml.includes('Next Dream Target: Exhaust'));
  assert(!context.fitmentCardHtml.includes('Buy Exhaust'));
  assert.strictEqual(context.fitmentMilestone.id, 'dream_target_exhaust');
...
`, context);
  ...
  assert(html.includes('/static/nospill/app.js?v=20260617i'));
  assert(html.includes('/static/nospill/app.css?v=20260617i'));
}
