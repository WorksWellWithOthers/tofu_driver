...
`, context);
  ...
  assert(context.inductionFiveCardHtml.includes('Induction &amp; Cooling Complete'));
  assert(context.inductionFiveCardHtml.includes('Next Build Track: Drivetrain &amp; Transmission'));
  ...
  assert(context.inductionFivePanelHtml.includes('Current focus: Drivetrain &amp; Transmission, future.'));
  assert(!context.inductionFivePanelHtml.includes('Buy Drivetrain'));
  assert(!context.inductionFivePanelHtml.includes('Install Drivetrain'));
  assert.strictEqual(context.inductionFivePinnedAfter.title, 'Induction & Cooling complete');
  assert.strictEqual(context.inductionFiveTickPinned.title, 'Induction & Cooling complete');
...
`, context);
  ...
  assert(html.includes('/static/nospill/app.js?v=20260619s'));
  assert(html.includes('/static/nospill/app.css?v=20260619s'));
}
