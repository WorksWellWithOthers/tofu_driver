...
`, context);
  ...
  assert(context.drivetrainFiveCardHtml.includes('Drivetrain &amp; Transmission Complete'));
  assert(context.drivetrainFiveCardHtml.includes('Next Build Track: Aero, Styling &amp; Weight Reduction'));
  assert(context.drivetrainFivePanelHtml.includes('Drivetrain &amp; Transmission'));
  assert(context.drivetrainFivePanelHtml.includes('Complete · Next Build Track: Aero, Styling &amp; Weight Reduction, future garage pass.'));
  assert(context.drivetrainFivePanelHtml.includes('Current focus: Aero, Styling &amp; Weight Reduction, future.'));
  assert(!context.drivetrainFivePanelHtml.includes('Buy Aero'));
  assert(!context.drivetrainFivePanelHtml.includes('Install Aero'));
  ...
  assert.strictEqual(context.drivetrainFivePinnedAfter.title, 'Drivetrain & Transmission complete');
  assert.strictEqual(context.drivetrainFiveTickPinned.title, 'Drivetrain & Transmission complete');
...
`, context);
  ...
  assert(html.includes('/static/nospill/app.js?v=20260619t'));
  assert(html.includes('/static/nospill/app.css?v=20260619t'));
}
