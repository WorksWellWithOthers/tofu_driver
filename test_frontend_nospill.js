...
`, context);
  ...
  assert(context.brakeFiveCardHtml.includes('Brakes &amp; Control Complete'));
  assert(context.brakeFiveCardHtml.includes('Next Build Track: Induction &amp; Cooling'));
  assert(context.brakeFivePanelHtml.includes('Brakes &amp; Control'));
  assert(context.brakeFivePanelHtml.includes('Complete · Next Build Track: Induction &amp; Cooling, future garage pass.'));
